...
public class CreateSQGFromLambda extends ProcessStreamInterface {
  ...
  public CreateSQGFromLambda(Map<String, JsonObject> sentToForest) {
  ...
  public static void main(String[] args) throws IOException,
    ...
    CreateSQGFromLambda merger =
        new CreateSQGFromLambda(sentToForest);
